...
(function (b) {
    var m = b(window),
        n = b("body"),
        l = b(".preloader");
    l.length && l.fakeLoader({ spinner: "spinner2", bgColor: !1 });
    var d = function (b, a) {
    ...
    b(function () {
        ...
        a.length && a.barrating({ theme: "fontawesome-stars-o", hoverState: !1 });
        ...
        e.length &&
            (function () {
                var b = new google.maps.Map(e[0], {
                    center: { lat: e.data("map-latitude"), lng: e.data("map-longitude") },
                ...
                if ("undefined" !== typeof e.data("map-marker")) {
                    var a = e.data("map-marker"),
                        c = 0;
                    for (c; c < a.length; c++) new google.maps.Marker({ position: { lat: a[c][0], lng: a[c][1] }, map: b, animation: google.maps.Animation.DROP, draggable: !0 });
                }
            })();
        ...
        a.length && a.datepicker({ showOtherMonths: !0, selectOtherMonths: !0 });
        ...
        "undefined" !== typeof b.cColorSwitcher &&
            b.cColorSwitcher({
                ...
                switcherColors: [
                    { bgColor: "#f69323", filepath: "css/colors/color-1.css" },
                    { bgColor: "#82b440", filepath: "css/colors/color-2.css" },
                    { bgColor: "#ff5252", filepath: "css/colors/color-3.css" },
                    { bgColor: "#e91e63", filepath: "css/colors/color-4.css" },
                    { bgColor: "#00BCD4", filepath: "css/colors/color-5.css" },
                    { bgColor: "#FC5143", filepath: "css/colors/color-6.css" },
                    { bgColor: "#00B249", filepath: "css/colors/color-7.css" },
                    { bgColor: "#D48B91", filepath: "css/colors/color-8.css" },
                    { bgColor: "#8CBEB2", filepath: "css/colors/color-9.css" },
                    { bgColor: "#119ee6", filepath: "css/colors/color-10.css" },
                ],
    ...
    m.on("load", function () {
        ...
        c.find(".service--item .dot").each(function () {
            var a = b(this);
            a.css({ top: d(a.data("position-top"), "auto"), left: d(a.data("position-left"), "auto"), right: d(a.data("position-right"), "auto") });
        });
        ...
        a.on("click", "li", function (a) {
            ...
            a = b(this);
            var c = a.data("target");
            h.isotope({ filter: "*" !== c ? '[data-cat~="' + c + '"]' : c });
