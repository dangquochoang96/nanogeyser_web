...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL::action('Admin\MenuController@listMenu') }}">Danh sách Menu</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="#">Thêm mới</a>
    ...
    <div class="portlet light">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject bold uppercase"> Chỉnh sửa Menu </span>
            </div>
        </div>
        <div class="portlet-body">
            <form method="POST" action="{{ URL::action('Admin\MenuController@editMenu',['id'=>$menu->id]) }}"
                        ...
                        <div class="col-md-7">
                                ...
                                <div>
                                    <a role="button" data-toggle="modal" data-target="#img-modal">
                                        <img style="width: 200px;height: auto; max-width: 100%" id="img-img"
                                             class="img-thumbnail" src="{{ url('/').$menu->image }}">
                                    </a>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txt-name" class="form-control"
                                       value="{{ old('txt-name', $menu->name) }}"/>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Link đến</label>
                                <input type="text" name="txt-url" class="form-control"
                                       value="{{ old('txt-url', $menu->url) }}"/>
                            </div>
                        <!--  <div class="form-group">
                            <label class="control-label">Link đến trang nội dung</label>
                            <input type="text" name="txt-url" class="form-control" value="{{ old('txt-url') }}"/>
                        </div> -->
                           <!--  <div class="form-group">
                                <label class="control-label">Menu cha</label>
                                <select name="sl-category" class="form-control select2me">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txt-order" class="form-control"
                                       value="{{ old('txt-order', $menu->order) }}"/>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="icheck-inline">
                                        ...
                                        <label class="control-label font-red-soft" role="button">
                                            <input type="radio" name="rd-status" value="2" class="icheck"
                                                   data-radio="iradio_minimal-green"
                                                   @if ($menu->status == 2)  checked @endif />
                                            Khóa
                                        </label>
                                    </div>
                                </div>
                            ...
                            <!-- <div class="form-group">
                                <label class="control-label">Vị trí menu</label>
                                <div class="input-group m-t-5 p-b-5">
                                    <div class="icheck-inline">
                                        <label class="control-label font-green" role="button">
                                            <input type="radio" name="is_left_menu" value="0" class="icheck"
                                                   data-radio="iradio_minimal-green"{!! ($menu->is_left_menu == 0) ? ' checked' : '' !!}/>
                                            Phải
                                        </label>
                                        <label class="control-label font-red-soft" role="button">
                                            <input type="radio" name="is_left_menu" value="1" class="icheck"
                                                   data-radio="iradio_minimal-green"{!! ($menu->is_left_menu == 1) ? ' checked' : '' !!}/>
                                            Trái
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group m-t-5 p-b-5">
                                    <div class="icheck-inline">
                                        <label class="control-label font-green" role="button">
                                            <input type="radio" name="is_big_menu" value="0" class="icheck"
                                                   data-radio="iradio_minimal-green"{!! ($menu->is_big_menu == 0) ? ' checked' : '' !!}/>
                                            Thường
                                        </label>
                                        <label class="control-label font-red-soft" role="button">
                                            <input type="radio" name="is_big_menu" value="1" class="icheck"
                                                   data-radio="iradio_minimal-green"{!! ($menu->is_big_menu == 1) ? ' checked' : '' !!}/>
                                            Menu Lớn
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ URL::action('Admin\MenuController@listMenu') }}" class="btn red-soft uppercase">Hủy
                        bỏ</a>
                </div>
            </form>
        </div>
