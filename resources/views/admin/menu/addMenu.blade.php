...
@section('content')
    ...
    <div class="portlet light">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject bold uppercase"> Thêm mới Menu </span>
            </div>
        </div>
        <div class="portlet-body">
            <form method="POST" action="{{ URL::action('Admin\MenuController@addMenu') }}" accept-charset="UTF-8"
                                ...
                                <div>
                                    <a role="button" data-toggle="modal" data-target="#img-modal">
                                        <img style="width: 200px;height: auto; max-width: 100%" id="img-img"
                                             class="img-thumbnail" src="{{ asset('upload/no-avatar.png') }}">
                                    </a>
                                </div>
