...
@section('content')
    ...
    <div class="portlet light">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject bold uppercase">Sửa danh mục</span>
            </div>
        </div>
        <div class="portlet-body">
            <form method="POST" action="{{route('product-categories.update', ['id' => $category->id])}}"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select name="parent_id" class="form-control select2me">
                                    <option value="0"{!! ($category->parent_id == 0) ? ' selected' : '' !!}>Danh mục
                                        gốc
                                    </option>
                                ...
                                <div>
                                    <a role="button" data-toggle="modal" data-target="#img-modal">
                                        <img style="width: 200px;height: auto; max-width: 100%" id="img-img"
                                             class="img-thumbnail" src="{{ url('/').$category->img }}">
                                    </a>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" id="btn-img" class="btn blue text-uppercase">Xác nhận
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="icheck-inline">
                                        <label class="control-label font-green" role="button">
                                            <input type="radio" name="status" value="1" class="icheck"
                                                   data-radio="iradio_minimal-green"{!! $category->status == '1' ? ' checked' : '' !!}/>
                                            Kích hoạt
                                        </label>
                                        <label class="control-label font-red-soft" role="button">
                                            <input type="radio" name="status" value="2" class="icheck"
                                                   data-radio="iradio_minimal-green"{!! $category->status == '2' ? ' checked' : '' !!}/>
                                            Khóa
                                        </label>
                                    </div>
                                </div>
