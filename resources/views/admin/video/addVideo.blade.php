...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL::action('Admin\VideoController@listVideo') }}">Danh sách Video</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="#">Thêm mới</a>
...
<div class="portlet light">
  <div class="portlet-title">
     <div class="caption">
        <span class="caption-subject bold uppercase"> Thêm mới Video </span>
     </div>
  </div>
  <div class="portlet-body">
      <form method="POST" action="{{ URL::action('Admin\VideoController@addVideo') }}" accept-charset="UTF-8" id="add-form" enctype="multipart/form-data">
        @csrf
            <div class="form-body">
                <div class="row">
                    <div class="col-md-7">
                        <div class="form-group">
                            <label class="control-label">Tên Video <span class="required"> * </span></label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="txt-link" class="form-control" value="{{ old('txt-link') }}"/>
                        </div>
                      <!--   <div class="form-group">
                            <label class="control-label">Danh mục <span class="required"> * </span></label>
                            <select name="sl_category_id[]" class="form-control select2me" multiple>
                                {{--<select name="sl_category_id[]" class="form-control">--}}
                                {{--@foreach ($categories as $cate)--}}
                                {{--<option value="{{$cate->id}}">--}}
                                {{--{{$cate->name}}--}}
                                {{--</option>--}}
                                {{--@endforeach--}}
                                {!! optionCategories($categories, 0, 0, old('sl_category_id', [])) !!}
                            </select>
                        </div> -->
                        <div class="form-group">
                            <label class="control-label">Thứ tự</label>
                            <input type="text" name="txt-order" class="form-control" value="{{ old('txt-order') }}"/>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div>
                                <a role="button" data-toggle="modal" data-target="#img-modal">
                                    <img style="width: 200px;height: auto; max-width: 100%" id="img-img" class="img-thumbnail" src="{{ asset('upload/no-avatar.png') }}">
                                </a>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <input type="hidden" class="txt-img-type" name="txt-img-type" value="url">
                                            <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" name="txt-keyword" class="form-control" value="{{ old('txt-keyword') }}"/>
                        </div>
                         <div class="form-group">
                            ...
                            <div class="input-group m-t-5 p-b-5">
                                <div class="icheck-inline">
                                    ...
                                    <label class="control-label font-red-soft" role="button">
                                        <input type="radio" name="rd-status" value="2" class="icheck" data-radio="iradio_minimal-green" />
                                        Khóa
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group m-t-5 p-b-5">
                                <div class="icheck-inline">
                                    <label class="control-label font-green" role="button">
                                        <input type="radio" name="rd-home" value="1" class="icheck" data-radio="iradio_minimal-green"  />
                                        Hiển thị
                                    </label>
                                    <label class="control-label font-red-soft" role="button">
                                        <input type="radio" name="rd-home" value="2" class="icheck" data-radio="iradio_minimal-green" checked/>
                                        Không hiển thị
                                    </label>
                                </div>
                            </div>
            ...
            <div class="form-actions">
                ...
                <a href="{{ URL::action('Admin\VideoController@listVideo') }}" class="btn red-soft uppercase">Hủy bỏ</a>
            </div>
            </form>
  </div>
</div>
