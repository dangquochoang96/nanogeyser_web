...
@section('content')
    ...
    <div class="portlet light">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject bold uppercase">Thêm mới bộ lọc</span>
            </div>
        </div>
        <div class="portlet-body">
            <form method="POST" action="{{route('product-filter.store')}}" accept-charset="UTF-8" id="add-form"
                            ...
                            <table class="table table-bordered table-hover" id="table-image">
                               ...
                               <tbody>
                                  <tr class="item-filter-0">
                                    ...
                                    <td>
                                        <input name="att[0][]" type="number" class="form-control" value="">
                                    </td>
                                     <td>
