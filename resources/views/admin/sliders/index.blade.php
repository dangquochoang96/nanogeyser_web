...
@section('content')
    ...
    <div class="portlet light">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{{ route('sliders.create') }}" class="btn blue uppercase">
                    ...
                    <table class="table table-bordered table-hover td-middle">
                        ...
                        <tbody>
                            @foreach ($sliders as $slider)
                                <tr>
                                    <td>{{ $loop->index + $sliders->currentPage() * $sliders->perPage() - $sliders->perPage() }}
                                    </td>
                                    <td>{{ $slider->name }}</td>
                                    <td><img src="{{ $slider->image_link }}" width="320px"></td>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger btn-sm my-delete-btn"
                                            data-action="{{ route('sliders.destroy', ['id' => $slider->id]) }}">Xóa
                                        </button>
                                    </td>
                                </tr>
                            @endforeach
