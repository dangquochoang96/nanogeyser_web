...
@section('content')
    ...
    <div class="portlet light">
        ...
        <div class="portlet-body">
            <form method="POST" action="{{route('sliders.update', ['id' => $slider->id])}}" accept-charset="UTF-8"
                  id="add-form"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{$slider->image_link}}" width="400px">
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group m-t-5 p-b-5">
                                    <div class="icheck-inline">
                                        <label class="control-label font-green" role="button">
                                            <input type="radio" name="type" value="1" class="icheck" data-radio="iradio_minimal-green"{{ $slider->type == 1 ? ' checked' : '' }}/>
                                            website
                                        </label>
                                        <label class="control-label font-red-soft" role="button">
                                            <input type="radio" name="type" value="2" class="icheck"
                                                   data-radio="iradio_minimal-green"{{ $slider->type == 2 ? ' checked' : '' }}/>
                                            mobile
                                        </label>
                                    </div>
                                </div>
