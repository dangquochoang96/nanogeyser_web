...
<div class="portlet light">
  ...
  <div class="portlet-body">
      <form method="POST" action="{{ URL::action('Admin\UserController@addUser') }}" accept-charset="UTF-8" id="user-form" enctype="multipart/form-data">
      	@csrf
            <div class="form-body">
                <div class="row">
                    <div class="col-md-7">
                        <div class="form-group">
                            ...
                            <input type="text" name="txt-username" class="form-control" value="{{ old('txt-username') }}"/>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Email <span class="required"> * </span></label>
                            <input type="text" name="txt-email" class="form-control" value="{{ old('txt-email') }}"/>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group m-t-5" style="padding-bottom: 3px;">
                                <div class="icheck-inline">
                                    <label class="control-label" role="button">
                                        <input type="radio" name="rd-gender" value="1" class="icheck" data-radio="iradio_minimal-green" checked />
                                        Nam
                                    </label>
                                    <label class="control-label" role="button">
                                        <input type="radio" name="rd-gender" value="2" class="icheck" data-radio="iradio_minimal-green" />
                                        Nữ
                                    </label>
                                </div>
                            </div>
