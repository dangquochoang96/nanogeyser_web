...
@section('content')
    ...
    <div class="portlet light">
        ...
        <div class="portlet-body">
            <form method="POST" action="{{ URL::action('Admin\ReviewController@edit',['id' => $review->id]) }}"
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input type="text" name="txt-name" class="form-control"
                                       value="{{ old('txt-name', $review->name) }}"/>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Thứ tự</label>
                                <input type="text" name="txt-order" class="form-control"
                                       value="{{ old('txt-order', $review->order) }}"/>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div>
                                    <a role="button" data-toggle="modal" data-target="#img-modal">
                                        <img style="width: 200px;height: auto; max-width: 100%" id="img-img"
                                             class="img-thumbnail" src="{{ url('/').$review->image }}">
                                    </a>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title text-uppercase">Chọn Ảnh</h4>
                                            </div>
                                    ...
                                    <div class="icheck-inline">
                                        ...
                                        <label class="control-label font-red-soft" role="button">
                                            <input type="radio" name="rd-status" value="2" class="icheck"
                                                   data-radio="iradio_minimal-green"
                                                   @if ($review->status == 2)  checked @endif/>
                                            Khóa
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ URL::action('Admin\ReviewController@list') }}" class="btn red-soft uppercase">Hủy
                        bỏ</a>
                </div>
            </form>
        </div>
