...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL::action('Admin\ReviewController@list') }}">Danh sách</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="#">Thêm mới</a>
...
<div class="portlet light">
  ...
  <div class="portlet-body">
      <form method="POST" action="{{ URL::action('Admin\ReviewController@add') }}" accept-charset="UTF-8" id="add-form" enctype="multipart/form-data">
        @csrf
            <div class="form-body">
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="txt-address" class="form-control" value="{{ old('txt-address') }}"/>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title text-uppercase">Chọn</h4>
                                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="txt-des" class="form-control">
                                {{ old('txt-des') }}
                            </textarea>
                        </div>
                    </div>
            ...
            <div class="form-actions">
                ...
                <a href="{{ URL::action('Admin\ReviewController@list') }}" class="btn red-soft uppercase">Hủy bỏ</a>
            </div>
            </form>
  </div>
</div>
