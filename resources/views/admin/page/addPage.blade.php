...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL::action('Admin\PageController@listPage') }}">Danh sách Pages</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="#">Thêm mới</a>
...
<div class="portlet light">
  <div class="portlet-title">
     <div class="caption">
        <span class="caption-subject bold uppercase"> Thêm mới Pages </span>
     </div>
  </div>
  <div class="portlet-body">
      <form method="POST" action="{{ URL::action('Admin\PageController@addPage') }}" accept-charset="UTF-8" id="add-form" enctype="multipart/form-data">
        @csrf
            <div class="form-body">
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            <label class="control-label">Tên Trang <span class="required"> * </span></label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="txt-shortdes" class="form-control ckeditor">
                                {{ old('txt-shortdes') }}
                            </textarea>
                        </div>
                        <div class="form-group">
            ...
            <div class="form-actions">
                ...
                <a href="{{ URL::action('Admin\PageController@listPage') }}" class="btn red-soft uppercase">Hủy bỏ</a>
            </div>
            </form>
  </div>
</div>
...
@section('script')
  ...
  <!-- <script type="text/javascript" src="{{ asset('quantri/theme/assets/global/plugins/ckeditor/ckeditor.js') }}"></script> -->
