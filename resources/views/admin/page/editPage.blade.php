...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL::action('Admin\PageController@listPage') }}">Danh sách Trang</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="#">Chỉnh sửa</a>
    ...
    <div class="portlet light">
        ...
        <div class="portlet-body">
            <form method="POST" action="{{ URL::action('Admin\PageController@editPage',['id' => $page->id]) }}"
                                ...
                                <div>
                                    <a role="button" data-toggle="modal" data-target="#img-modal">
                                        <img style="width: 200px;height: auto; max-width: 100%" id="img-img"
                                             class="img-thumbnail" src="{{ url('/').$page->image }}">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="txt-keyword" class="form-control"
                                       value="{{ old('txt-keyword', $page->keywords) }}"/>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="icheck-inline">
                                        ...
                                        <label class="control-label font-red-soft" role="button">
                                            <input type="radio" name="rd-status" value="2" class="icheck"
                                                   data-radio="iradio_minimal-green"
                                                   @if ($page->status == 2)  checked @endif/>
                                            Khóa
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ URL::action('Admin\PageController@listPage') }}" class="btn red-soft uppercase">Hủy
                        bỏ</a>
                </div>
            </form>
        </div>
