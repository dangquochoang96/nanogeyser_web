...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('brands.index') }}">Danh sách Danh mục</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="{{URL::current()}}">Sửa thương hiệu</a>
            </li>
        </ul>
    ...
    <div class="portlet light">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject bold uppercase">Sửa thương hiệu</span>
            </div>
        </div>
        <div class="portlet-body">
            <form method="POST" action="{{route('brands.update', ['id' => $brand->id])}}" accept-charset="UTF-8"
                  id="add-form"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">Ảnh (Bỏ trống nếu không muốn thay đổi)<span class="required"> * </span></label>
                                <input type="file" name="image" class="form-control" value=""/>
                                <img src="{{url($brand->image)}}" width="320px">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
